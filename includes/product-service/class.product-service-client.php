...
class psClient{
	...
	public $ext_path;
	public $pluginCat = "relevant-related-posts-extensions";
	public $pluginName = "Relevant Related Posts";
	public $urlFAQ = "https://erlycoder.com/knowledgebase_category/related-posts-with-relevanssi/";
	public $urlSupport = "https://erlycoder.com/support/";

	public function __construct($slug, $text_domain, $settings){
		$this->pluginSlug = $slug;
		$this->text_domain = $text_domain;
		
		$this->ext_page = $settings."&tab=ext";
	...
	*/
	public function extra_admin_menu(){
		...
		add_submenu_page('related-posts-with-relevanssi', __( 'Support', 'related-posts-with-relevanssi'), __( 'Support', 'related-posts-with-relevanssi'),	'manage_options', 'related-posts-with-relevanssi-support',	[$this, 'support_page'], 60);
	}
	
	public function support_page(){
		?>
		<h1><?php _e("Need Help", 'related-posts-with-relevanssi'); ?>?</h1>

		<div class="rpwr_admin_info">
			<div>
			<p><?php _e("We are trying to make our plugins simple to use and include some explanations where they are required (to our mind)", 'related-posts-with-relevanssi'); ?>.
				<?php _e("However we do not know what can be unclear to you", 'related-posts-with-relevanssi'); ?>. <?php _e("We are tying to provide more detailed explanations and examples in", 'related-posts-with-relevanssi'); ?> <a href="<?php echo $this->urlFAQ; ?>"><?php _e("Questions & Answers", 'related-posts-with-relevanssi'); ?></a>.
			</p>
			<p>
				<?php _e("If we have not responded your specific question in", 'related-posts-with-relevanssi'); ?> <b><?php _e("Questions & Answers", 'related-posts-with-relevanssi'); ?></b> <?php _e("section", 'related-posts-with-relevanssi'); ?>, <?php _e("feel free to", 'related-posts-with-relevanssi'); ?> <a href="<?php echo $this->urlSupport; ?>"><?php _e("contact us", 'related-posts-with-relevanssi'); ?></a> <?php _e("and we will try to provide you required help as soon as possible", 'related-posts-with-relevanssi'); ?>.
			</p>
			
			<p>
				<?php _e("Sure, we will be happy to hear from you what features are you missing and what should be improved, chaged or fixed", 'related-posts-with-relevanssi'); ?>.
			</p>
			</div>
	...
	public function extensions_page(){
		?>
		<h1><?php _e("Plugin Extensions & Other Suggested Plugins", 'related-posts-with-relevanssi'); ?></h1>
	...
	public function showExt(){
		...
		*/
		...
		?><h2><?php _e("Extensions", 'related-posts-with-relevanssi'); ?></h2><?php
		}
		...
		?><div class="ps-product-lst-item">
			...
			<div class="ps-product-lst-item-name">
				<b><?php echo $item['name']; ?></b>&nbsp;&nbsp;<a href="#"><?php _e("Read more", $this->text_domain); ?></a>
		...
		<?php } ?>
		<?php foreach($items['products_plug'] as $item) if($item['name']!=$this->pluginName){
		?><div class="ps-product-lst-item">
			<div style="width: 50px; height: 50px; background-image: url(<?php echo $item['image']; ?>); background-size: contain; background-repeat: no-repeat; margin-right: 10px;"></div>
			<div class="ps-product-lst-item-name">
				<b><?php echo $item['name']; ?></b>&nbsp;&nbsp;<a href="#"><?php _e("Read more", $this->text_domain); ?></a>
		...
		<div class="ps-product-checkout-row ps-product-checkout">
			...
			<button class="ps-product-checkout" type="button" onclick="psInst.proceedCheckout(<?php echo $user_id; ?>, '<?php echo $this->pluginSlug; ?>'); return false;"><b id="ps-product-total-num">0</b>&nbsp; <?php _e("Plugins for", $this->text_domain); ?>&nbsp; <b id="ps-product-total-price">$0.00</b>&nbsp; - &nbsp;<b><?php _e("Complete purchase", $this->text_domain); ?></b></button>
		</div>
